...
<figure style="text-align: center;">
  <img src="yeti_sb5c_loaded_up.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="boulder_strewn_river_crossing_to_get_into_the_brecon_beacons_2.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="climb_upto_brecons_beacons_1.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="cycle_route_from_dolgach_north_2.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="cycle_route_from_dolgach_north_9.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="cycle_route_from_dolgach_north_13.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="moel_prysgau_bothy_3.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="cycle_route_from_dolgach_north_14.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
 <figure style="text-align: center;">
  <img src="dyll_faen_forest_track_3.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="dyll_faen_forest_track_4.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="angler_s_retreat_bivvy_1.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="mach_to_barmouth_coast_road_1.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
...
<figure style="text-align: center;">
  <img src="llyn_cowlyd_reservoir_the_last_off_road_section.jpg" 
       alt="failed to load image" 
       style="max-width: 100%; height: auto;">
