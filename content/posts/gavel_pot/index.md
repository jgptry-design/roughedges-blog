...
tags:
  - caving
  - Yorkshire-Dales
description: A "follow your nose" caving trip down Gavel Pot on the Yorkshire Dales
draft: false
date: 2013-03-14
...
<figure style="text-align: center;">
  <img src="massive_peg_in_entrance.jpg" 
       alt="ALT TEXT" 
       style="max-width: 100%; height: auto;">
  <figcaption><i>Now that's a big peg</i></figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="warning_in_entrance jpg" 
       alt="ALT TEXT" 
       style="max-width: 100%; height: auto;">
...
The way on to the straight forward second pitch is to walk down slope. It can be free climbed by the looks of it although it is loose. The third pitch is a climb down some impressive dry stone walling, especially when you consider the amount of work that has gone into digging all the rocks out. Apparently this has collapsed in the past so hanging a rope down it is probably a good idea.
...
<figure style="text-align: center;">
  <img src="glasfurd_s_chamber_-_13.jpg" 
       alt="ALT TEXT" 
       style="max-width: 100%; height: auto;">
  <figcaption><i>Glasfurd's Chamber</i></figcaption>
</figure>

<figure style="text-align: center;">
  <img src="glasfurd_s_chamber_-_06.jpg" 
       alt="ALT TEXT" 
       style="max-width: 100%; height: auto;">
  <figcaption><i>Glasfurd's Chamber</i></figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="p3120240.jpg" 
       alt="ALT TEXT" 
       style="max-width: 100%; height: auto;">
  <figcaption><i>Breathe out</i></figcaption>
</figure>
